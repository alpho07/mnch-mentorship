                    ...
                    Forms\Components\Section::make('Select Mentees')
                        ...
                        ->schema([
                            ...
                            Forms\Components\CheckboxList::make('selected_users')
                                ...
                                ->default(function () {
                                    // Pre-select already enrolled mentees
                ...
                ->action(function (array $data) {
                    ...
                    DB::transaction(function () use ($usersToAdd, $usersToRemove) {
                        ...
                        foreach ($usersToAdd as $userId) {
                            ...
                            // Auto-create module progress with exemption check
                            $this->createModuleProgressForParticipant($participant);
                        }
                    });
                    
                    $messages = [];
                    if (count($usersToAdd) > 0) $messages[] = count($usersToAdd) . ' mentee(s) added';
                    if (count($usersToRemove) > 0) $messages[] = count($usersToRemove) . ' mentee(s) removed';
