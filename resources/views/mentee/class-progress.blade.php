...
<html lang="en" class="h-full">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 flex items-center gap-3">
        ...
        <div class="flex-1 min-w-0">
            <p class="text-sm font-semibold text-slate-800 dark:text-slate-200">MNCH Mentorship Manual</p>
            <p class="text-xs text-slate-400 dark:text-slate-500 truncate">Evidence-based reference for infant and child care</p>
        </div>
