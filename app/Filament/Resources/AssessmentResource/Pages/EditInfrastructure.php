...
class EditInfrastructure extends EditRecord {
    ...
    public function form(Form $form): Form {
        ...
        return $form->schema([
                            ...
                            ->description('Physical infrastructure and facility availability')
                            ->schema(
    ...
    protected function getSavedNotification(): ?Notification {
        ...
        return Notification::make()
                        ->title('Infrastructure section saved successfully')
    ...
    protected function getNextSection(): ?string {
        ...
        $currentIndex = array_search('infrastructure', array_keys($sections));
    ...
    public function getTitle(): string {
        return "Infrastructure - {$this->record->facility->name}";
    }
