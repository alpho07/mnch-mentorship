...
class EditInformationSystems extends EditRecord {
    ...
    public function form(Form $form): Form {
        ...
        return $form->schema([
                            Forms\Components\Section::make('Information Systems Assessment')
                            ->description('Health information systems and data management')
                            ->schema(
    ...
    protected function mutateFormDataBeforeSave(array $data): array {
        ...
        $progress['information_systems'] = true;
    ...
    protected function getSavedNotification(): ?Notification {
        ...
        return Notification::make()
                        ->title('Information Systems section saved successfully')
    ...
    protected function getNextSection(): ?string {
        ...
        $currentIndex = array_search('information_systems', array_keys($sections));
    ...
    public function getTitle(): string {
        return "Information Systems - {$this->record->facility->name}";
    }
